...
public class TurboDropBar implements Listener {
    ...
    public TurboDropBar(Main plugin, int duration) {
        this.plugin = plugin;
    ...
    private void updateBarTitle() {
        String turboDropDuration = formatTime(countdown);
        String title = ChatColor.DARK_RED + "Boss" + ChatColor.GOLD + "Cash " + ChatColor.GREEN + "-> "
                + ChatColor.YELLOW + "TurboDrop: " + turboDropDuration + ChatColor.RESET + ChatColor.GREEN + " <- "
    ...
    private void createBar() {
        String turboDropDuration = formatTime(duration);
        String title = ChatColor.DARK_RED + "Boss" + ChatColor.GOLD + "Cash " + ChatColor.GREEN + "-> "
                + ChatColor.YELLOW + "TurboDrop: " + ChatColor.RESET  + ChatColor.GREEN + " <- "
                + ChatColor.GOLD + "Boss" + ChatColor.DARK_RED + "Cash ";
